    ...
    var tpl = '\<div id="csdn-toolbar" style="background-color:#cb060f !important;" class="csdn-toolbar tb_disnone ' + skin + fixed + '">\
        <div class="container row center-block ">\
          ...
          <div class="pull-right login-wrap '+ loginMark + '">\
            <ul class="btns">\
              <li class="write-bolg-btn" data-report-click=\'{"mod":"popu_370","pid":"toolbar","dest":"https://mp.csdn.net/postedit"}\' data-report-view=\'{"mod":"popu_370","pid":"toolbar","dest":"https://mp.csdn.net/postedit"}\'>\
              <a class="" href="//mp.csdn.net/postedit" target="_blank" id="blogClick">\
